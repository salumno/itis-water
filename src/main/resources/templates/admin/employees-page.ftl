    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="/admin/employees">Сотрудники</a></li>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-2">
            <button class="btn btn-danger" onclick="fadeAddForm()">Добавить</button>
        </div>
    </div>
    <form id="add-form" style="display: none" class="employee-add-form">
        ...
        <#list model.employees as employee>
            <form id="employee-form-${employee.id}">
                <div class="row">
                    <div class="col-md-10"></div>
                    <div class="col-md-2">
                        <button id="edit-button-${employee.id}" class="btn btn-warning" type="button" onclick="editEmployee(${employee.id})">Изменить</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                ...
                <button id="edit-submit-button-${employee.id}" class="btn btn-success" type="button" onclick="submitEdit(${employee.id})" style="display: none">Сохранить</span></button>
        ...
        for (var i = 0; i < employees.length; i++) {
            ...
            '<form id="employee-form-' + employee.id + '">' +
                ...
                '<div class="row">' +
                    ...
                    '</div>' +
                '</div>' +
                '<button id="edit-submit-button-' + employee.id +'" class="btn btn-success" type="button" onclick="submitEdit(' + employee.id + ')" style="display: none">Сохранить</button>' +
                '<button id="edit-cancel-button-' + employee.id +'" class="btn btn-danger" type="button" onclick="cancelEdit(' + employee.id + ')" style="display: none">Отмена</button>' +
                '<hr>' +
            '</form>'
            );
